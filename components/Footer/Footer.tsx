...
//             © 2024 Orbit Zone Inc. All rights reserved.
//           </p>
  ...
  return (
    <>
      <footer>
        ...
        <div className="pt-1 bg-gradient-to-b from-gray-100 to-transparent">
          <div className="container px-6 m-auto space-y-8 text-gray-600 md:px-12 lg:px-20">
            <div className="grid grid-cols-8 gap-6 md:gap-0">
              <div className="col-span-8 border-r border-gray-100 md:col-span-2 lg:col-span-3">
                <div className="flex items-center justify-between gap-6 py-6 border-b border-white md:block md:space-y-6 md:border-none md:py-0">
                  <h1 className="text-4xl font-semibold">Orbit Zone</h1>
              ...
              <div className="col-span-8 md:col-span-6 lg:col-span-5">
                ...
                <div className="flex justify-between py-4 pb-8 border-t border-gray-100 md:pl-16">
                  <span>&copy; Orbit Zone 2024</span>
