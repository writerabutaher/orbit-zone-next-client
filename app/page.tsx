      ...
      <div className="relative w-full h-full pb-10">
        ...
        <div className="relative px-4 xl:px-0 container mx-auto md:flex items-center gap-8">
          <div className="text-color w-full md:w-1/3 pt-16 lg:pt-32 xl:pt-12">
            <h1 className="text-4xl md:text-4xl lg:text-6xl w-11/12 lg:w-11/12 xl:w-full text-gray-900 font-extrabold f-f-l uppercase">
              Find Your Perfect Ride, Sell with Ease
            </h1>
            <div className="f-f-r text-base lg:text-lg pb-20 sm:pb-0 pt-10 xl:pt-6">
              <h2>
                CarHub is the go-to online platform for individuals looking to
          ...
          <img
            className="w-full md:mt-0 object-fill md:w-2/3 md:-ml-4 lg:-ml-4 xl:ml-0"
            src="./super.png"
            alt="sample page"
            role="img"
          />
